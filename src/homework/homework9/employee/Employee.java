...
public class Employee {
    ...
    public Employee(String employeeId, String name, String surname, String company, String position, double salary) {
    ...
    public int hashCode() {
        int result;
        long temp;
        result = getEmployeeId() != null ? getEmployeeId().hashCode() : 0;
